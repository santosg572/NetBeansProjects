...
public class Iden_SCL90 extends JPanel implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (x1 == 0 || x2 == 0 || x3 == 0 || x4 == 0 || x5 == 0 || x6 == 0 || x7 == 0 || x8 == 0 || x9 == 0 || x10 == 0 || x11 == 0 || x12 == 0 ){
            ...
            if ('0' <= e1 && e1 <= '9' && '0' <= e2 && e2 <= '9' &&
                ...
                File_Ini filein = new File_Ini();
                filein.doFile_Ini("file_in.txt");
                Une_Campos Unecampos = new Une_Campos();
                Unecampos.doUne_Campos(Valores, "file_in.txt", "file_ou.txt");
                File_Cpy Filecpy = new File_Cpy();
                Filecpy.doFile_Cpy("file_ou.txt", "file_in.txt");
		Todas.setVisible(false);
		this.remove(Todas);
		Todas.setVisible(false);
                Inform frame1 = new Inform();
...
//		frame1.setSize(600, 600);
  //              frame1.setVisible(true);
		...
		frame1.setLocation (x0, y0);
		frame1.setSize(ex, ey);
		frame1.setVisible(true);
